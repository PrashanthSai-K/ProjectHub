...
import { EditProjectSidebar } from "@/app/admin/components/edit-project-sidebar"
import { Button } from "@/components/ui/button"
import Link from "next/link"
import { useToast } from "@/hooks/use-toast"
import { UserService } from "@/services/user-service"

export default function ProjectDetails({ project: initialProject, messages, fetchProjectData }) {
  ...
  useEffect(() => {
    ...
    return (
        <div className="space-y-6">
            ...
            <TaskManagement projectId={project.id} teamMembers={JSON.parse(project.team_members)} showOnlyMyTasks={false} />
